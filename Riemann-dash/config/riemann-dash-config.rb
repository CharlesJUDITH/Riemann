...
riemann_base = '/usr/lib64/ruby/gems/1.9.1/gems/riemann-dash-0.2.10'
...
#config.store[:ws_config] = "#{riemann_base}/config/dashboard.json"
config.store[:ws_config] = "#{riemann_base}/dashboard.json"
